...
Above are the instances from the analysis I done.

> [!NOTE]
> The complete PDF analysis of mine can be accessed [here](https://drive.google.com/file/d/18G5C3skP-vLt-l6ihj83CP1ZoNbguXQc/view?usp=drive_link)
...
> [!NOTE]
> Click on the images above and they would route you towards the video. Do hit a like if u liked my explanation and share it if possible hehe (usual youtuber line hehe).
...
> [!NOTE]
> A few edge cases like the one above and possible explanations of it have been included in the Edge-Cases folder hosted by this repository.
...
> [!TIP]
> Below are a tips I would like to share
...
## Variations and expanding the depth of analysis:
